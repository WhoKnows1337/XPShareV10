...
export interface ExperienceSubmitStore {
  // ========================================
  // GLOBAL STATE
  // ========================================
  ...
  updateExtractedField: (field: keyof ExperienceSubmitStore['extractedData'], value: any) => void
...
export const useExperienceSubmitStore = create<ExperienceSubmitStore>()(
  devtools(
    persist(
      (set, get) => ({
        ...initialState,
